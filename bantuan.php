                            ...
                            <div class="post-holder">
                                ...
                                <div class="post-content">
                                    ...
                                    <div class="post-header">
                                        <h1>Panduan Pendaftaran Online Calon Siswa(i) SMP Negeri 2 Rana</h1>
                                        <div class="meta">
                                            <!-- post meta -->
                                    ...
                                    <p>Tahun Ajaran 2017/2018 ini, Kami dari SMP Negeri 2 Rana mulai melakukan penerimaan calon siswa(i) baru secara online.
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                <div class="author-bio">
                                                    <div class="author-header">
                                                        <h3><a href="#" class="title">LEO YOU</a></h3>
                                                    </div>
                                                    <div class="author-content">
                                                        <p><strong>Education</strong> is the most powerful weapon which you can use to change the world.<br>~Leo You.</p>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="footer-widget">
                            <h2 class="widget-title">SMP Negeri 2 Rana</h2>
                            <ul class="listnone contact">
                                ...
                                <li><i class="fa fa-envelope-o"></i> Smpbersama@gmail.com</li>
                            </ul>
                        </div>
                    </div>
